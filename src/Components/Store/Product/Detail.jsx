...
console.log(productsSl.reviews);
  ...
  //   axios.post(`${baseURL}/api/reviews`,JSON.stringify( {review:reviewData,user:userData.user , product:product}),{headers:authHeaders})
  //     .then(response => {
    ...
    <>
      {productsSl.loading || cart.loading ? (
        ...
        <div className="container-fluid mt-3 productDetail">
          ...
          {productsSl.reviews?.length>0?<h2>Product Reviews</h2> :""}
