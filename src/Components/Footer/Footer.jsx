      ...
      <div className="container">
        <div className="footer-columns row ">
            ...
            <div className='text-white col-md-4'>
                <h6 className='mt-3'>New To Jumia?</h6>
                <p>Subscribe to our newsletter to get updates on our latest offers!</p>
                <form action="#" method="post"> 
                <input className='form-control' placeholder=' Enter E-Mail Address' type="text" />
                <button className='m-3 btn btn-outline-info px-4 text-white'>Male</button>
                <button className='m-3 btn btn-outline-info px-3 text-white'>Female</button>
                
                </form>
                <div className='terms d-flex justify-content-between'>
                <input className='check' type="checkbox" name="agree" id="agree" required/>
                <label className='agree my-3' htmlFor="agree" >I agree to Jumia's Privacy and Cookie Policy. You can unsubscribe from newsletters at any time. <br /> <a href=""> I accept the Legal Terms</a></label>
            </div>
           
            </div>
            <div className=' col-md-4'>
                <div className='text-white m-4 d-flex'>
                    <img className='mx-3 logo2' src={logoo} alt="" />
                    <div>
                ...
                <div className='store'>
               <a href=""><i className="  mx-4 text-white fa-brands fa-google-play"></i></a>
               <a href=""><i className=" text-white fa-brands fa-apple"></i></a>
            </div>
            </div>
